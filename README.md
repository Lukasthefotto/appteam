...
This API provides functionality for managing and retrieving workout data, as well as providing health and weather information related to workouts. <span style="color: red;">**(API KEY FOR WEATHER NOT PROVIDED)**</span>
